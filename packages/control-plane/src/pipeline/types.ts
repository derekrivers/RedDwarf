...
export const EventCodes = {
  ...
  SCOPE_RISK_DETECTED: "SCOPE_RISK_DETECTED",
  OPENCLAW_COMPLETION_TIMED_OUT: "OPENCLAW_COMPLETION_TIMED_OUT",
  OPENCLAW_SESSION_TERMINATED: "OPENCLAW_SESSION_TERMINATED",
  OPENCLAW_SESSION_STALLED: "OPENCLAW_SESSION_STALLED",
  ...
  HEARTBEAT_KICKED: "HEARTBEAT_KICKED",
