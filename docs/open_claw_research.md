...
For RedDwarf, this means you can keep model choice as configuration and choose between direct OpenAI API usage and Codex OAuth depending on how you want billing, entitlements, and environment setup to work. ([docs.openclaw.ai](https://docs.openclaw.ai/providers/openai?utm_source=chatgpt.com))
...
- OpenAI provider page: API key and Codex auth guidance. ([docs.openclaw.ai](https://docs.openclaw.ai/providers/openai?utm_source=chatgpt.com))
...
7. Hooks and webhook  
8. Skills  
9. Windows / platform docs if running from your current home-PC stack ([docs.openclaw.ai](https://docs.openclaw.ai/concepts/agent-workspace?utm_source=chatgpt.com))