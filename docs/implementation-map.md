...
- V1 activates `intake -> eligibility -> planning -> policy_gate`, plus a human-gated `development` phase that still keeps product code-writing disabled by default.
