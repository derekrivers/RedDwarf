...
- `packages/control-plane`: planning pipeline, state transitions, concurrency/stale-run enforcement, approval queue and decision workflow helpers, workspace context and runtime instruction materialization, managed workspace lifecycle helpers, structured observability logging, and policy-pack packaging helpers
