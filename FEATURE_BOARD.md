...
| 102      | Resume approved retries from the failed phase instead of replaying upstream phases - let operator-approved recovery restart validation or SCM directly without re-running developer work | M16 | pending | Control Plane, Failure Recovery Model, Execution Plane             |
